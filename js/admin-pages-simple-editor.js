  ...
  pageForm=async function(x={},products=ADMIN.cache.pageProducts||[],allPages=ADMIN.cache.pages||[]){
    ...
    openModal(`<h2>${x.id?'Editar página':'Nova página'}</h2><form id="page-form" class="page-simple-editor">
      <div class="page-editor-section">
        ...
        <div class="form-field full" id="page-configurator-wrap"><div class="measure-admin-head"><div><label>Opções deste menu</label><small class="field-hint">Adicione um ou vários configuradores. O nome abaixo é o que o cliente verá no submenu.</small></div><button type="button" id="add-page-configurator" class="ghost-btn">+ Adicionar opção</button></div><div id="page-configurator-builder" class="page-configurator-builder"></div></div>
