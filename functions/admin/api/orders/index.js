...
export async function onRequestGet(context) {
  ...
  let sql=`SELECT o.id, o.order_number, o.customer_name, o.customer_email, o.customer_phone, o.status, o.stage, o.subtotal_cents, o.freight_cents, o.discount_cents, o.total_cents, o.internal_notes, o.created_at, o.updated_at, (SELECT COUNT(*) FROM orders seq WHERE seq.store_id=o.store_id AND (seq.created_at<o.created_at OR (seq.created_at=o.created_at AND seq.id<=o.id))) AS sale_number FROM orders o WHERE o.store_id='salvatex'`;
  const binds=[];
